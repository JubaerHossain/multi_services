          ...
          <div class="row justify-content-between">
             ...
             <div class="col-lg-3 col-sm-6">
                ...
                <ul class="footer-address-list ftr-details">
                   <li>
                      ...
                      <p>Email <span> <a href="mailto:honesttradersbd@gmail.com">honesttradersbd@gmail.com</a></span></p>
                   </li>
                   <li>
                      <span><i class="fas fa-phone-alt"></i></span>
                      <p>Phone <span> <a href="tel:+880 12345 678987">+880 12345 678987</a></span></p>
                   </li>
                   <li>
             ...
             <div class="col-lg-2 col-sm-6">
                ...
                <ul class="footer-address-list link-hover">
                   ...
                   <li><a href="copyrights.php">License & Copyright</a></li>
                </ul>
             </div>
          ...
          <div class="container">
             <div class="row">
                <div class="col-lg-12">
                   ...
                   <div class="footer-">
                      <p>© 2020-2022. All Rights Reserved By <a href="" target="blank">Honest Traders Ltd.</a></p>
                   </div>
                </div>
             </div>
          </div>
