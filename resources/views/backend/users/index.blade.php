...
@section('title', trans('language.users'))
@push('css')
    ...
    <div class="page-header">
        <div class="card p-2">
            ...
            <div class="row flex-fill">
                <div class="col-auto">
                    <h2 class="page-title">
                      <a>@lang('language.user') @lang('language.manage')</a>
                    </h2>
                </div>
      ...
      <div class="row flex-fill">
        <div class="col-auto ml-auto d-print-none">
            ...
            <a href="{{ route('user.create')}}" class="btn btn-purple">
                ...
                @lang('language.add') @lang('language.user')</a>
            </a>
            </div>
        </div>
    </div>
        <div class="col-lg-12">
                  <table class="table card-table table-vcenter text-nowrap datatable w-100 mt-2" id="table">
                        <thead>
                           <tr>
                              <th>ID</th>
                              <th width='15%'> @lang('language.name')</a></th>
                              <th width='20%'> @lang('language.email')</a></th>
                              <th width='15%'>@lang('language.phone')</th>
                              <th width='20%'>@lang('language.role')</th>
