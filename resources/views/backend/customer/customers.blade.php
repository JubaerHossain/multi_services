  ...
  <div class="container-xl mb-5">
    ...
    <div class="page-header">
        <div class="card p-2">
            ...
            <div class="row flex-fill">
                <div class="col-auto">
                    <h2 class="page-title">
                      @lang('customers.title')  @lang('customers.list')
                    </h2>
                </div>
                <div class="col-auto ml-auto d-print-none">
                    <div class="d-flex">
                        ...
                        <a>@lang('customers.title')  @lang('customers.list')</a>
                    </div>
                </div>
            </div>
    ...
    <div class="row row-deck row-cards">
      <div class="row flex-fill">
        <div class="col-auto ml-auto d-print-none">
            <div class="d-flex">
            <a href="{{ url('customer/create')}}" class="btn btn-purple">
                  ...
                  <table class="table card-table table-vcenter text-nowrap datatable" id="table" style="width: 100%">
                        <thead>
                           <tr>
                              ...
                              <th>@lang('customers.fax')</th>
                              <th>@lang('customers.address')</th>
                              <th>@lang('customers.status')</th>
                              <th class="text-right">@lang('customers.action')</th>
                           </tr>
                        </thead>
                     </table>
        </div>
