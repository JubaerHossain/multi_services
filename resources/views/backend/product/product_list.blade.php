  ...
  <div class="container-xl mb-5">
    ...
    <div class="page-header">
        <div class="card p-2">
            ...
            <div class="row flex-fill">
                <div class="col-auto">
                    <h2 class="page-title">
                        @lang('products.product') @lang('products.list')
                    </h2>
                </div>
                <div class="col-auto ml-auto d-print-none">
                    <div class="d-flex">
                        ...
                        <a>@lang('products.product') @lang('products.list')</a>
                    </div>
                </div>
            </div>
    ...
    <div class="row row-deck row-cards">
      <div class="row flex-fill">
        <div class="col-auto ml-auto d-print-none">
            <div class="d-flex">
            <a href="{{url('/admin/product/create')}}" class="btn btn-purple" id="add_new_product">
