    ...
    <div class="page-header">
        <div class="card p-2">
            ...
            <div class="row flex-fill">
                <div class="col-auto">
                    <h2 class="page-title">
                        @lang('language.portfolio') @lang('supplied.show')
                    </h2>
                </div>
                <div class="col-auto ml-auto d-print-none">
                    <div class="d-flex">
                        ...
                        <a> @lang('language.portfolio') @lang('supplied.show') </a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    <div class="d-flex">
                        <a href="{{url('/admin/portfolio')}}" class="btn btn-primary ml-auto">Back</a>
                    </div>
                </div>              
            </div>
        </div>
