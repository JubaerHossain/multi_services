    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-12">  
                <div class="card">   
                    @if (@$data['edit'])
                    {{Form::open (['route' => ['service.update', @$data['edit']->id] ,'class' => 'card', 'id' => 'service-form', 'files' => 'true', 'method' => 'PUT'] )}}                    
                    @else                    
                        {!! Form::open(['route' => 'service.store', 'enctype' => 'multipart/form-data','method' => 'post', 'languages' => true, 'id' => 'service-form']) !!}
                    @endif               
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    {{Form::textarea('description',@$data['edit'] ? @$data['edit']->description : null,['class' => 'form-control' ,'id' => 'textarea', 'placeholder' => trans('products.desc'), 'Description'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                        <div class="card-footer text-right">
                            <div class="d-flex">
                                <a href="{{url('/admin/service')}}" class="btn btn-link">Back</a>
