    ...
    <div class="page-header">
                ...
                <div class="col-auto ml-auto d-print-none">
                    <div class="d-flex">
                        <a href="{{url('/admin/work')}}">
                            @lang('language.work') @lang('language.manage')
                        </a>
                        <a href="javascript:;">
        ...
        <div class="row">
            <div class="col-12">  
                <div class="card">   
                    @if (@$data['edit'])
                    {{Form::open (['route' => ['work.update', @$data['edit']->id] ,'class' => 'card', 'id' => 'work-form', 'files' => 'true', 'method' => 'PUT'] )}}                    
                    @else                    
                        {!! Form::open(['route' => 'work.store', 'enctype' => 'multipart/form-data','method' => 'post', 'languages' => true, 'id' => 'work-form']) !!}
                    @endif               
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="mb-3">
                                    {{Form::label('title','Client', ['class' => 'form-label required'])}}
                                    {{Form::text('client',@$data['edit'] ? @$data['edit']->client :null, ['class' => 'form-control'])}}
                                </div>
                                <div class="mb-3">
                                    {{Form::label('title','Location', ['class' => 'form-label required'])}}
                                    {{Form::text('location',@$data['edit'] ? @$data['edit']->location :null, ['class' => 'form-control'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                        <div class="card-footer text-right">
                            <div class="d-flex">
                                <a href="{{url('/admin/work')}}" class="btn btn-link">Back</a>
