...
@section('title', @$data['edit'] ?  trans('language.edit') :  'Client')
@push('css')
    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-12">  
                <div class="card">   
                    @if (@$data['edit'])
                    {{Form::open (['route' => ['partner.update', @$data['edit']->id] ,'class' => 'card', 'id' => 'service-form', 'files' => 'true', 'method' => 'PUT'] )}}                    
                    @else                    
                        {!! Form::open(['route' => 'partner.store', 'enctype' => 'multipart/form-data','method' => 'post', 'languages' => true, 'id' => 'service-form']) !!}
                    @endif               
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    {{Form::label('title','Name', ['class' => 'form-label required'])}}
                        ...
                        <div class="card-footer text-right">
                            <div class="d-flex">
                                <a href="{{url('/admin/partner')}}" class="btn btn-link">Back</a>
