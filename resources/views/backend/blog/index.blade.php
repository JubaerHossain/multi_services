...
@section('title', trans('language.blog'))
@push('css')
  ...
  <div class="container-xl mb-5">
    ...
    <div class="page-header">
        <div class="card p-2">
            ...
            <div class="row flex-fill">
                <div class="col-auto">
                    <h2 class="page-title">
                      <a>@lang('language.blog') @lang('language.manage')</a>
                    </h2>
                </div>
    ...
    <div class="row row-deck row-cards">
      <div class="row flex-fill">
        <div class="col-auto ml-auto d-print-none">
            <div class="d-flex">
            <a href="{{ route('blog.create')}}" class="btn btn-purple">
                ...
                @lang('language.add') @lang('language.blog')</a>
            </a>
            </div>
        </div>
    </div>
